...
Review @AI_README.md, all files in @context/ and especially @context/implementation-plan-v1.md. Then help me implement Slice 11. Ask me any questions you may have before writing code. And if you'd like, feel free to create a task list or whatever for this slice under @context/ 
